...
//     for (int row_index = 0; row_index < DISPLAY_ROWS; row_index++) {
//         for (int col_index = 0; col_index < DISPLAY_COLS; col_index++) {
//             bool pixel = mewo_get_pixel(m, row_index, col_index);

//             if (pixel) {
//                 mvwaddch(win, board_startx + row_index, board_starty + col_index, ACS_CKBOARD);
//             } else {
//                 mvwaddch(win, board_startx + row_index, board_starty + col_index, ' ');
//             }
//         }
//     }
